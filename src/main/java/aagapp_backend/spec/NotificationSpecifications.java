...
public class NotificationSpecifications {
    ...
    public static Specification<Notification> hasRole(String role) {
    ...
    public static Specification<Notification> hasVendorId(Long vendorId) {
        return (root, query, cb) -> {
    ...
    public static Specification<Notification> hasCustomerId(Long customerId) {
        return (root, query, cb) -> {
    ...
    public static Specification<Notification> hasAmount(Double amount) {
        return (root, query, cb) -> {
    ...
    public static Specification<Notification> hasMinAmount(Double minAmount) {
        return (root, query, cb) -> {
    ...
    public static Specification<Notification> hasMaxAmount(Double maxAmount) {
        return (root, query, cb) -> {
    ...
    public static Specification<Notification> createdBetween(ZonedDateTime start, ZonedDateTime end) {
        return (root, query, cb) -> {
    ...
    public static Specification<Notification> descriptionContains(String keyword) {
        return (root, query, cb) -> {
    ...
    public static Specification<Notification> detailsContains(String keyword) {
        return (root, query, cb) -> {
            if (keyword == null || keyword.isBlank()) return null;
